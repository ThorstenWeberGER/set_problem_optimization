...
The engine ensures that site selection is driven by mathematical efficiency and geographic reality.
"""
...
BASE_CONFIG = {
    ...
    'candidates_path': os.path.join(PARENT_DIR, 'results', 'german_cities.csv'),
